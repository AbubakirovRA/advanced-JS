...
// Мы определяем массив albums, в котором хранятся альбомы, каждый из которых имеет поля title, artist и year.

// Затем мы выбираем элемент списка(musicList), где мы будем выводить информацию об альбомах.

// Затем мы используем цикл for...of для итерации по объекту musicCollection.
// На каждой итерации мы создаем новый элемент списка(li), добавляем ему класс music - collection__album,
